...
const PasswordInput = ({value, onChange, placeholder}) => {
  ...
  return (
    <div className='flex items-center bg-transparent border-[1.5px] px-5 rounded mb-3'>
        <input className='w-full text-sm bg-transparent py-3 mr-3 rounded outline-none' type={isShowPassword? "text" : "password"} value={value} onChange={onChange} placeholder={placeholder || "Password"} />
